    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-background/90" data-testid="philosophy-page">
        ...
        <div className="relative pt-20 pb-16 px-4">
          ...
          <div className="absolute top-12 left-12 text-accent/20 text-5xl font-mono hidden sm:block">ψ</div>
          <div className="absolute top-16 right-16 text-primary/20 text-4xl font-mono hidden sm:block">∇</div>
          <div className="absolute bottom-20 left-20 text-consciousness/20 text-6xl font-mono hidden sm:block">∞</div>
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-accent via-consciousness to-primary bg-clip-text text-transparent" data-testid="philosophy-title">
